...
├── companeros.html                # (por crear) página de la tienda de Compañeros
├── colegio-winterhold.html        # (por crear) página de la tienda del Colegio
├── belethor.html                  # (por crear)
├── adrianne-herreria.html         # (por crear)
├── farengar.html                  # (por crear)
├── comerciantes-solitude.html     # (por crear)
├── arcadias-cauldron.html         # (por crear)
└── corcel-encabritado.html        # (por crear)
```
